                        ...
                        <div class="row single-slide align-items-center d-flex">
                            <div class="col-lg-5 col-md-6">
                                <div class="banner-content">
                                    ...
                                    <div class="add-bag d-flex align-items-center d-none">
                                        <a class="add-btn d-none" href=""><span class="lnr lnr-cross d-none"></span></a>
                                        <span class="add-text text-uppercase d-none">Pesan Sekarang</span>
                                    </div>
                                </div>
                            </div>
